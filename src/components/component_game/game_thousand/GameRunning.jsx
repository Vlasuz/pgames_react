...
const GameRunning = ({setStepOfGame}) => {
    ...
    const cardsLft = useSelector(state => {
        const {cardsListLftReducer} = state
        return cardsListLftReducer.cards
    })
    const cardsRht = useSelector(state => {
        const {cardsListRhtReducer} = state
        return cardsListRhtReducer.cards
    })
        ...
        if (isMyStep) {
            ...
            setTimeout(() => {
                ...
                document.querySelectorAll('.one-thousand__cards--item')[0].innerHTML = `
                    <div class="one-thousand__cards--item-body">
                        <img src="images/cards/${cardsLft[step].card_type}-${cardsLft[step].card_suit}.svg" alt="" class="one-thousand__cards--img">
                    </div>
                `
                ...
                setTimeout(() => {
                    ...
                    document.querySelectorAll('.one-thousand__cards--item')[1].innerHTML = `
                        <div class="one-thousand__cards--item-body">
                            <img src="images/cards/${cardsRht[step].card_type}-${cardsRht[step].card_suit}.svg" alt="" class="one-thousand__cards--img">
                        </div>
                    `

                    setTimeout(() => {

                        let rht_type = cardsRht[step].card_type
                        let rht_suit = cardsRht[step].card_suit

                        let lft_type = cardsLft[step].card_type
                        let lft_suit = cardsLft[step].card_suit

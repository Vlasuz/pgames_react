...
export const Notifications: React.FC<INotificationsProps> = () => {
    ...
    const notification: string[] = useSelector((state: any) => state.toolkit.notification)
        ...
        <div className="notifications">
            <div className="notifications__body">
                <ul className="notifications__list">
                    ...
                    {
                        notification?.map((item, index) => <NotificationItem key={item} itemData={item?.slice(0, item?.indexOf('|'))} />)
                    }
                    ...
                    {/*            <img src={bell} width="20" height="20" alt=""*/}
                    {/*                 className="notification-item__icon"/>*/}
                    ...
                    {/*            <img src={error} width="20" height="20" alt=""*/}
                    {/*                 className="notification-item__icon"/>*/}

            ...
            <div className="account-aside__body">
                <ul className="account-aside__list">
                    <li className="account-aside__item">
                        <NavLink to={"/profile"} className={({isActive}) => `account-aside__link ${isActive && "_active"}`}>
                    ...
                    <li className="account-aside__item">
                        <NavLink to={"/profile-settings"} className={({isActive}) => `account-aside__link ${isActive && "_active"}`}>
                    ...
                    <li className="account-aside__item">
                        <NavLink to={"/profile-history"} className={({isActive}) => `account-aside__link ${isActive && "_active"}`}>
                    ...
                    <li className="account-aside__item">
                        <NavLink to={"/profile-referral"} className={({isActive}) => `account-aside__link ${isActive && "_active"}`}>
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <li className="account-aside__item">
                        <NavLink to={"/profile-withdrawals"} className={({isActive}) => `account-aside__link ${isActive && "_active"}`}>

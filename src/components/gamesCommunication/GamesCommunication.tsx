...
interface IGamesCommunicationProps {

}

export const GamesCommunication: React.FC<IGamesCommunicationProps> = () => {
            ...
            <div className="game__communication--chat game__chat" style={{display: "none"}}>
                <div className="game__chat--body">
                    <div className="game__chat--header">
                        <button className="game__chat--close-btn" type="button" title="Закрыть чат">
                    ...
                    <ul className="game__chat--list">
                        <li className="game__chat--item">
                            <div className="game__chat--avatar">
                                <img src="img/account/avatar.png" width="24" height="24" alt=""/>
                            </div>
                            <div className="game__chat--info">
                                ...
                                <div className="game__chat--text">
                                    Aliqua id fugiat nostrud irure ex duisAliqua id fugiat nostrud
                                    irure ex
                                </div>
                            </div>
                        </li>

...
const NotificationSuccessPayment = ({handleClose, isActive}) => {
    return (
        <li id={"notification_payment-success"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>

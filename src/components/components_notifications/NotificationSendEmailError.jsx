...
const NotificationSendEmailError = ({handleClose, isActive}) => {
    return (
        <li id={"notification_send-an-email-error"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>

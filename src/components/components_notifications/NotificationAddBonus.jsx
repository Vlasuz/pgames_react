...
const NotificationAddBonus = ({handleClose, isActive}) => {
    return (
        <li id={"notification_add-bonus"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>

...
const NotificationSendEmail = ({handleClose, isActive}) => {
    return (
        <li id={"notification_send-an-email"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>

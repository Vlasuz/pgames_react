...
const NotificationChangePassword = ({handleClose, isActive}) => {
    return (
        <li id={"notification_change-password"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>

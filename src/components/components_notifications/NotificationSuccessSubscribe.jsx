...
const NotificationSuccessSubscribe = ({handleClose, isActive}) => {
    return (
        <li id={"notification_subscribe-success"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>
...
export default NotificationSuccessSubscribe;
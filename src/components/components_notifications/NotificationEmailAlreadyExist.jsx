...
const NotificationEmailAlreadyExist = ({handleClose, isActive}) => {
    return (
        <li id={"notification_email-already-exist"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>
...
export default NotificationEmailAlreadyExist;
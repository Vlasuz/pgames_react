...
const NotificationPromoCode404 = ({handleClose, isActive}) => {
    return (
        <li id={"notification-promo-404"} className={"notifications__item notification-item" + (isActive ? " notification-item_show" : "")}>

            ...
            <nav className="header__nav">
                <div className="header__nav--body">
                    <ul className="header__nav--list">
                        ...
                        {
                            Object.keys(routes)
                                ?.filter(item => routes[item].isHeader)
                                ?.map((item) =>
                                    <li className="header__nav--item" key={item}>
                                        <NavLink to={item}
                                                 className={({isActive}) => `header__nav--link ${isActive && "_current"}`}>
                                            {
                                                routes[item].title
                                            }
                                        </NavLink>
                    ...
                    {!!Object.keys(user).length && <HeaderUserInfo/>}
                    <HeaderLanguages/>
                    {!!Object.keys(user).length ? <HeaderUser/> : <HeaderLogin/>}
                </div>
            </nav>
                ...
                <div className="header__nav-mob--body">
                    <ul className="header__nav-mob--list">
                        <li className="header__nav-mob--item">
                            <div
                                className="header__nav-mob--account header__mob-account header__mob-select custom-select _active">
                                <button type="button" title="Профиль"
                                        className="header__mob-account--target header__mob-select--target custom-select__target">
                                    <picture>

                                        <img src={avatar} width="27" height="27" alt=""
...

                        {
                            Object.keys(routes).map((item) =>
                                <li className="header__nav-mob--item" key={item}>
                                    <NavLink to={item}
                                             className={({isActive}) => `header__nav-mob--link ${isActive && "_current"}`}>
                                        {
                                            routes[item].title
                                        }
                                    </NavLink>

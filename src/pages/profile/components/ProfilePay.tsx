...
interface IProfilePayProps {

}

export const ProfilePay: React.FC<IProfilePayProps> = () => {

    const [value, setValue] = useState<string>('')
    const [payType, setPayType] = useState<string>("chips") // money
                ...
                <div className="account__block--body">
                    <div className="account-balance">
                        ...
                        <div className="account-balance__main">
                            <form onSubmit={handlePay} className="account-balance__block _visible"
                                  id="balance-chips">
                                <div className="account-balance__block--body">
                                    <div className="account-balance__block--header">
                                        <Select list={[
                                            {
                                                title: `${svgChips} Фишки`,
                                                slug: "chips",
                                            },
                                            {
                                                title: `${svgMoney} Деньги`,
                                                slug: "money",
                                            }
                                        ]} setValue={setPayType}/>
                                    </div>
                                    <label className="account-balance__label form-label">
                                        ...
                                        <span
                                            ...
                                            10 {payType === "chips" ? "фишек" : "денег"}
                                        </span>
                                        <span className="account-balance__input--tooltip">
                                            <span>Мин. $5, 1 {payType === "chips" ? "фишка" : "деньга"}</span>
                                            <span>Макс. $5000, 100 {payType === "chips" ? "фишек" : "денег"}</span>
                                        </span>
                                    </label>
                                </div>
                                <div className="account-balance__btn-list">
                                    <button type="button" className="account-balance__min-btn"
                                            onClick={_ => setValue("10")}>
                                        10
                                    </button>
                                    <button type="button" className="account-balance__min-btn"
                                            onClick={_ => setValue("25")}>
                                        25
                                    </button>
                                    <button type="button" className="account-balance__min-btn"
                                            onClick={_ => setValue("50")}>
                                        50
                                    </button>
                                </div>

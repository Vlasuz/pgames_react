                                        ...
                                        <div className="account__block--body">
                                            <div className="account-balance">
                                                ...
                                                <div className="account-balance__main">
                                                    <form action="#" className="account-balance__block _visible"
                                                          id="balance-chips">
                                                        <div className="account-balance__block--body">
                                                            <div className="account-balance__block--header">
                                                                <button type="button"
                                                                        className="account-balance__target">
                                                    ...
                                                    <form action="#" className="account-balance__block"
                                                          id="balance-money">
                                                        <div className="account-balance__block--body">
                                                            <div className="account-balance__block--header">
                                                                <button type="button"

...
const AccountMob = () => {
    ...
    return (
        <li className="header__nav-mob--item">
            <div
                className={"header__nav-mob--account header__mob-account header__mob-select custom-select" + (isActive ? " _active" : "")}>
                ...
                <div className="header__mob-select--block custom-select__block">
                    <ul className="header__mob-select--list">
                        ...
                        <li className="header__mob-select--item">
                            <a onClick={_ => logout(dispatch)} className="header__mob-select--link">
                                <svg width="14" height="12" viewBox="0 0 14 12" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path

...
const Notifications = () => {
    ...
    return (
        <div ref={ref} className={"header__user-info--notifications header__notifications" + (isActive ? " _active" : "")}>
            <button className="header__notifications--toggle-btn" type="button"
                    title="Уведомления" onClick={_ => setIsActive(!isActive)}>
                        ...
                        <li className="header__notifications--item notification-item">
                            <div className="notification-item__body">
                                <div className="notification-item__header">
                                    <img src="img/icons/info.svg" width="20" height="20" alt=""
                        ...
                        <li className="header__notifications--item notification-item">
                            <div className="notification-item__body">
                                <div className="notification-item__header _message">
                                    <img src="img/icons/bell.svg" width="20" height="20" alt=""
                                         className="notification-item__icon"/>

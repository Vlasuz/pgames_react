...
const AuthViaSocials = () => {
    return (
        <div className="popup-via">
            <div className="popup-via__body">
                ...
                <ul className="popup-via__list">
                    <li className="popup-via__item">
                        <a href="src/layouts/popups/layouts#" className="popup-via__btn" title="Facebook">
                    ...
                    <li className="popup-via__item">
                        <a href="src/layouts/popups/layouts#" className="popup-via__btn" title="Google">
                    ...
                    <li className="popup-via__item">
                        <a href="src/layouts/popups/layouts#" className="popup-via__btn" title="Apple">

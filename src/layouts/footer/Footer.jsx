...
import background from './../../assets/img/footer/bg.webp';
            ...
            <div className="footer__bg">
                <picture>
                    ...
                    <img src={background} loading="lazy"
                         alt="" width="0" height="0" className="footer__bg--img"/>
                </picture>
            </div>
            <div className="footer__container container _large">
                <div className="footer__intro">
                    <Logo className={"footer__intro-logo"}/>
                    ...
                    <ul className="footer__hot--list">
                        <li className="footer__hot--item">
                            <a href="page-game.html" className="footer__hot--link" title="Название игры">
                                <picture>
                                    <source srcSet="img/main-page/games/image-6.webp" type="image/webp"/>
                        ...
                        <li className="footer__hot--item">
                            <a href="page-game.html" className="footer__hot--link" title="Название игры">
                                <picture>
                                    <source srcSet="img/main-page/games/image-7.webp" type="image/webp"/>
                        ...
                        <li className="footer__hot--item">
                            <a href="page-game.html" className="footer__hot--link" title="Название игры">
                                <picture>
                                    <source srcSet="img/main-page/games/image-1.webp" type="image/webp"/>

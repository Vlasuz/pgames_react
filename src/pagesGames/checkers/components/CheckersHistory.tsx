...
interface ICheckersHistoryProps {

}

export const CheckersHistory: React.FC<ICheckersHistoryProps> = () => {

    return (
        <div className="checkers__history game__history">
            <div className="game__history--wrapper">
                ...
                <ul className="game__history--list">

...
import {IPlayerUser} from "../../../models";

interface ICheckersOpponentProps {
    opponent: IPlayerUser
}

export const CheckersOpponent: React.FC<ICheckersOpponentProps> = ({opponent}) => {

    return (
        <div className="checkers__player">
            <div className="game__player">
                <div className="game__player--body">
                    <div className="game__player--avatar">
                        <img src={getApiLink("/" + opponent?.avatar)} width="76" height="76" alt=""
